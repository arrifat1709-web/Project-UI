const base_url = "https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v1";
export const base_url_v2 = "https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v2";
...
export const getOrderList = async (query = "") => {
  const response = await fetch(`${base_url}/order?sort=-createdAt&${query}`);
  const json = await response.json();
  return json;
};
...
export const getCategories = async () => {
  const response = await fetch(
    `https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v1/category?status=true`
  );
  const json = await response.json();
  return json;
};
...
export const getCategories2 = async () => {
  const response = await fetch(
    `https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v1/category`
  );
  const json = await response.json();
  return json;
};
...
export const getCategoriesAndSubCategory = async () => {
  const response = await fetch(
    `https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v1/category/category-and-subcategory`
  );
  const json = await response.json();
  return json;
};
