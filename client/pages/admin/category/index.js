...
const CategoryTableItem = dynamic(
  () => import("../../../src/Shared/TableItem/TableItemCategory"),
  {
    loading: () => <p>Loading...</p>,
  }
);
...
const Category = () => {
  ...
  let categoryUrl = `https://project-sever-782ljcc4e-rifats-projects-5ccf7744.vercel.app/api/v1/category/`;
